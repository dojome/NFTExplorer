...
export function SearchBox({ className, placeholder, setValue, loading }) {
  ...
  return (
    ...
    >
      ...
      />
      {address && (
        <button className="border-l border-pink-500 pl-3 text-pink-500" onClick={() => handleSearch(address)}>
          {loading ? (
            <svg
              aria-hidden="true"
              class="mr-2 inline h-6 w-6 animate-spin fill-pink-600 text-gray-200 dark:text-gray-600"
              viewBox="0 0 100 101"
              fill="none"
